...
class MoviesPostNewTest extends TestCase
{
     ...
     * @test 
     */
    public function movie_store_should_fail_if_user_not_authenticated()
    {
     ...
     * @test 
     */
    public function movie_store_should_fail_if_required_param_not_passed()
    {
     ...
     * @test 
     */
    public function movie_store_should_pass_if_request_is_okay()
    {
